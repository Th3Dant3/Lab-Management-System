  ...
  document.getElementById('goalBars').innerHTML = goalRows.map((r, i) => {
    ...
    return `
      <div class="goal-row">
        ...
        <div class="goal-target">Goal ${Number(r.target).toFixed(2)}%</div>
      </div>`;
  }).join('');
...
function renderDashboardMap(summary) {
  ...
  <div class="fcc-dept-card dashboard-card"
     onclick="window.location.href='../Production Dashboards/Surface/SurfaceWIP.html'"
     data-type="dashboard"
     data-key="Surface"
  ...
  <div class="fcc-mini-bar">
   ...
   <div class="fcc-dept-card dashboard-card"
     onclick="window.location.href='../Production Dashboards/AR/ARDash.html'"
     data-type="dashboard"
     data-key="AR"
     style="cursor:pointer">
  ...
  <div class="fcc-mini-bar">
    ...
    <div class="fcc-dept-card dashboard-card"
         onclick="window.location.href='../Production Dashboards/Finish/FinishDash.html'"
         data-type="dashboard"
         data-key="Finish"
         style="cursor:pointer">
