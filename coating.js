...
modalBody.innerHTML = ` <h2>${point.rx !== "Machine Flow" ? "RX " + point.rx : "Machine Flow"}</h2> <div style="margin-top:14px;padding:18px;background:rgba(255,255,255,0.03);border:1px solid rgba(120,160,255,0.12);border-radius:10px;font-family:${CHART_FONT};font-size:13px;"> <div style="margin-bottom:10px"><span style="color:rgba(100,140,180,0.6);font-size:10px;text-transform:uppercase;letter-spacing:1.2px;">Machine</span><br><strong style="color:#c8dff5;">${point.machine}</strong></div> <div style="margin-bottom:10px"><span style="color:rgba(100,140,180,0.6);font-size:10px;text-transform:uppercase;letter-spacing:1.2px;">Breakage Reason</span><br><strong style="color:#c8dff5;">${point.reason || "None"}</strong></div> <div style="margin-bottom:10px"><span style="color:rgba(100,140,180,0.6);font-size:10px;text-transform:uppercase;letter-spacing:1.2px;">Flow Time</span><br><strong style="color:${GC.cyan};font-size:22px;">${fmt}</strong></div> <div><span style="color:rgba(100,140,180,0.6);font-size:10px;text-transform:uppercase;letter-spacing:1.2px;">Hour</span><br><strong style="color:#c8dff5;">${point.x}</strong></div> </div>`;
